...
@XmlType(name = IntegrationJobAction.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
public class IntegrationJobAction extends BusinessObject<IntegrationJobAction> implements IIntegrationJobAction {
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_ACTIONID = registerProperty(PROPERTY_ACTIONID_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_ACTIONNAME = registerProperty(PROPERTY_ACTIONNAME_NAME, String.class, MY_CLASS);
    ...
    * 
    */ 
    public static final IPropertyInfo<IIntegrationJobActionCfgs> PROPERTY_INTEGRATIONJOBACTIONCFGS = registerProperty(PROPERTY_INTEGRATIONJOBACTIONCFGS_NAME, IIntegrationJobActionCfgs.class, MY_CLASS);
    /**
    * 获取-集成任务-动作-配置集合
    * 
    * @return 值

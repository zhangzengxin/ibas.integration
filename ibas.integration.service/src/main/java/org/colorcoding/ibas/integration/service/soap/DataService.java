...
public class DataService extends BORepositoryIntegration {
     ...
     */
    @WebMethod
    public OperationResult<IntegrationJob> fetchIntegrationJob(@WebParam(name = "criteria") Criteria criteria, @WebParam(name = "token") String token) {
     ...
     */
    @WebMethod
    public OperationResult<IntegrationJob> saveIntegrationJob(@WebParam(name = "bo") IntegrationJob bo, @WebParam(name = "token") String token) {

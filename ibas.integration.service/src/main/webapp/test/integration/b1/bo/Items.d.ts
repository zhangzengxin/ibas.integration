...
export interface IItems {
    ...
    attributeGroups: IItemsAttributeGroups[];
    autoCreateSerialNumbersOnRelease: number;
    avgStdPrice: number;
    barCode: string;
    barCodes: IItemBarCodes[];
    baseUnitName: string;
    ...
    depreciationParameters: IItemsDepreciationParameters[];
    desiredInventory: number;
    distributionRules: IItemsDistributionRules[];
    ...
    indirectTax: number;
    intrastatExtension: IItemIntrastatExtension;
    ...
    localizationInfos: IItemLocalizationInfos[];
    location: number;
    mainsupplier: string;
    ...
    periodControls: IItemsPeriodControls[];
    picture: string;
    planningSystem: number;
    preferredVendors: IItems_PreferredVendors[];
    priceList: IItems_Prices;
    procurementMethod: number;
    prodStdCost: number;
    productSource: number;
    projects: IItemsProjects[];
    ...
    unitOfMeasurements: IItemUnitOfMeasurements[];
    ...
    whsInfo: IItemWarehouseInfo[];
}


export interface IItemsAttributeGroups {
    attribute1: string;
    attribute10: string;
    attribute11: string;
    attribute12: string;
...
export interface IItemBarCodes {
    absEntry: number;
    barCode: string;
    freeText: string;
    uoMEntry: number;
...
export interface IItemsDepreciationParameters {
...
export interface IItemsDistributionRules {
...
export interface IItemIntrastatExtension {
...
export interface IItemLocalizationInfos {
    incomeNature: string;
    itemCode: string;
}

export interface IItemsPeriodControls {
    actualUnits: number;
    depreciationArea: string;
...
export interface IItems_PreferredVendors {
    bpCode: string;
}

export interface IItems_Prices {
    ...
    uoMPrices: IUoMPrices[];
    userFields: IUserFields;
}

export interface IUoMPrices {
    additionalCurrency1: string;
    additionalCurrency2: string;
    additionalPrice1: number;
    additionalPrice2: number;
...
export interface IItemsProjects {
    lineNumber: number;
    project: string;
    validFrom: Date;
    validTo: Date;
...
export interface IItemUnitOfMeasurements {
...
export interface IItemUoMPackages {
    height1: number;
    height1Unit: number;
    height2: number;
    height2Unit: number;
...
export interface IItemWarehouseInfo {
    committed: number;
    costAccount: string;
    ...
    itemCycleCount: IItemCycleCount;
    locked: number;
    maximalStock: number;
    minimalOrder: number;
    minimalStock: number;
...
export interface IItemCycleCount {
    alert: number;
    alertTime: Date;
    cycleCode: number;

...
import {
    IIntegrationJob,
    IIntegrationJobActions,
    IIntegrationJobAction,
...
/** 集成任务 */
export class IntegrationJob extends BOSimple<IntegrationJob> implements IIntegrationJob {
    ...
    get activated(): emYesNo {
        return this.getProperty<emYesNo>(IntegrationJob.PROPERTY_ACTIVATED_NAME);
    }
    /** 设置-是否激活 */
    ...
    protected init(): void {
        ...
        this.objectCode = config.applyVariables(IntegrationJob.BUSINESS_OBJECT_CODE);
    }
}

/** 集成任务-动作 集合 */
export class IntegrationJobActions extends BusinessObjects<IntegrationJobAction, IntegrationJob> implements IIntegrationJobActions {
...
/** 集成任务-动作 */
export class IntegrationJobAction extends BOSimpleLine<IntegrationJobAction> implements IIntegrationJobAction {
...
export class IntegrationJobActionCfgs
    extends BusinessObjects<IntegrationJobActionCfg, IntegrationJobAction> implements IIntegrationJobActionCfgs {
...
/** 集成任务-动作-配置 */
export class IntegrationJobActionCfg extends BOSimpleLine<IntegrationJobActionCfg> implements IIntegrationJobActionCfg {

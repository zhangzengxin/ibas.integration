...
import { IIntegrationJobListView } from "../../../bsapp/integrationjob/index";

/**
 * 列表视图-集成任务
 */
export class IntegrationJobListView extends ibas.BOListView implements IIntegrationJobListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.IntegrationJob>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.IntegrationJob>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.IntegrationJob[] {
        return utils.getTableSelecteds<bo.IntegrationJob>(this.table);
    }
}

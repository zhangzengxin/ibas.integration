...
import { IIntegrationJobViewView } from "../../../bsapp/integrationjob/index";

/**
 * 查看视图-集成任务
 */
export class IntegrationJobViewView extends ibas.BOViewView implements IIntegrationJobViewView {

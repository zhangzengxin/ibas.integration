...
import { IIntegrationJobChooseView } from "../../../bsapp/integrationjob/index";

/**
 * 选择视图-集成任务
 */
export class IntegrationJobChooseView extends ibas.BOChooseView implements IIntegrationJobChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
